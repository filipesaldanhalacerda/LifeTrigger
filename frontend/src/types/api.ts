...
export type EvaluationStatusType = 'ABERTO' | 'CONVERTIDO' | 'ARQUIVADO' | 'CONVERTIDO_PARCIAL'
...
export interface PilotReport {
  ...
  totalAll?: number
  statusDistribution?: { aberto: number; convertido: number; parcial: number; arquivado: number }
